...
def get_checkpoint_path(config, train_config, version, load_from_epoch):
    """
...
def get_or_build_state(
    config, train_config, tokenizer, version, initial_train, load_from_epoch
):
    """
    ...
    ckpt_path = get_checkpoint_path(config, train_config, version, load_from_epoch)
...
def save_checkpoint_state(
    model, optimizer, scheduler, epoch, val_loss, val_ppl, config, train_config, version
):
    """
    ...
    curr_ckpt = curr_ckpt + train_config["ckpt_format"]  # full filename with format
